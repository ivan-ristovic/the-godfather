    ...
    public void GetLocalizedTimeTests()
    {
        TestDbProvider.SetupAlterAndVerify(
            ...
            _ => {
                ...
                Assert.That(this.Service.GetLocalizedTimeString(MockData.Ids[1], dt), Does.Match("1/1/2020 12:00 ?PM"));
                ...
                Assert.That(this.Service.GetLocalizedTimeString(MockData.Ids[1], dto, "G"), Does.Match("1/1/2020 11:00:00 ?AM"));
