    ...
    public void GetLocalizedTimeTests()
    {
        TestDbProvider.SetupAlterAndVerify(
            ...
            _ => {
                ...
                Assert.That(this.Service.GetLocalizedTimeString(MockData.Ids[1], dt), Is.EqualTo("1/1/2020 12:00PM"));
                ...
                Assert.That(this.Service.GetLocalizedTimeString(MockData.Ids[1], dto, "G"), Is.EqualTo("1/1/2020 11:00:00AM"));
