...
namespace TheGodfather.Tests.Modules.Administration.Services
{
    public sealed class GuildConfigServiceTests : ITheGodfatherServiceTest<GuildConfigService>
    {
        ...
        public void GetCachedConfigTests()
        {
            TestDbProvider.SetupAlterAndVerify(
                ...
                verify: _ => {
                    ...
                    Assert.That(HaveSamePropertyValues(this.gcfgs[MockData.Ids[0]].CachedConfig, this.Service.GetCachedConfig(MockData.Ids[0])));
                    Assert.That(HaveSamePropertyValues(this.gcfgs[MockData.Ids[1]].CachedConfig, this.Service.GetCachedConfig(MockData.Ids[1])));
                }
            );
        }
        ...
        public void GetGuildPrefixTests()
        {
            ...
            TestDbProvider.SetupAlterAndVerify(
                setup: this.SetMockGuildConfig,
                alter: _ => this.Service.LoadData(),
                verify: _ => {
                    Assert.That(this.Service.GetGuildPrefix(MockData.Ids[0]), Is.EqualTo(this.gcfgs[MockData.Ids[0]].Prefix));
        ...
        public void IsMemberExemptedTests()
        {
            TestDbProvider.SetupAlterAndVerify(
                ...
                alter: _ => this.Service.LoadData(),
                verify: _ => {
                    Assert.That(this.Service.IsMemberExempted(gid: MockData.Ids[0], uid: MockData.Ids[0], new[] { MockData.Ids[0] }), Is.True);
                    Assert.That(this.Service.IsMemberExempted(gid: MockData.Ids[1], uid: MockData.Ids[0], new[] { MockData.Ids[1] }), Is.True);
                    ...
                    Assert.That(this.Service.IsMemberExempted(gid: MockData.Ids[4], uid: MockData.Ids[3], new[] { MockData.Ids[0] }), Is.True);
            ...
            TestDbProvider.SetupAlterAndVerify(
                ...
                verify: _ => {
                    ...
                    Assert.That(this.Service.IsMemberExempted(gid: MockData.Ids[0], uid: MockData.Ids[2], new[] { MockData.Ids[0] }), Is.True);
                    Assert.That(this.Service.IsMemberExempted(gid: MockData.Ids[1], uid: MockData.Ids[2], new[] { MockData.Ids[0] }), Is.True);
                    Assert.That(this.Service.IsMemberExempted(gid: MockData.Ids[2], uid: MockData.Ids[2], new[] { MockData.Ids[2] }), Is.False);
                    Assert.That(this.Service.IsMemberExempted(gid: MockData.Ids[3], uid: MockData.Ids[2], new[] { MockData.Ids[2] }), Is.False);
                }
            );
        }
