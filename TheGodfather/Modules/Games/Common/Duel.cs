...
namespace TheGodfather.Modules.Games.Common
{
    public class Duel : ChannelEvent
    {
        ...
        public override async Task RunAsync()
        {
            ...
            _msg = await Channel.SendIconEmbedAsync($"{_p1.Mention} {_hp1bar} {StaticDiscordEmoji.DuelSwords} {_hp2bar} {_p2.Mention}")
            ...
            await Channel.SendIconEmbedAsync($"{StaticDiscordEmoji.DuelSwords} {Winner.Mention}, FINISH HIM! {StaticDiscordEmoji.DuelSwords}")
                .ConfigureAwait(false);
