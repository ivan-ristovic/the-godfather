...
public sealed partial class GamesModule : TheGodfatherServiceModule<GameStatsService>
{
    ...
    public Task LeaderboardAsync(CommandContext ctx)
    {
        return ctx.RespondWithLocalizedEmbedAsync(async emb => {
            ...
            emb.AddLocalizedField(TranslationKey.str_game_top_ar, top, true);
            ...
            emb.AddLocalizedField(TranslationKey.str_game_top_caro, top, true);
            ...
            emb.AddLocalizedField(TranslationKey.str_game_top_c4, top, true);
            ...
            emb.AddLocalizedField(TranslationKey.str_game_top_duel, top, true);
            ...
            emb.AddLocalizedField(TranslationKey.str_game_top_hm, top, true);
            ...
            emb.AddLocalizedField(TranslationKey.str_game_top_nr, top, true);
            ...
            emb.AddLocalizedField(TranslationKey.str_game_top_tr, top, true);
            ...
            emb.AddLocalizedField(TranslationKey.str_game_top_rr, top, true);
            ...
            emb.AddLocalizedField(TranslationKey.str_game_top_ot, top, true);
            ...
            emb.AddLocalizedField(TranslationKey.str_game_top_quiz, top, true);
            ...
            emb.AddLocalizedField(TranslationKey.str_game_top_ttt, top, true);
        });
    }
    #endregion
        ...
        [Description(TranslationKey.desc_user)] DiscordUser? user = null)
    {
        ...
        await ctx.RespondWithLocalizedEmbedAsync(emb => {
            ...
            if (stats is null) {
                ...
                emb.AddLocalizedField(TranslationKey.str_game_stats_nr, stats.BuildNumberRaceStatsString(), true);
                emb.AddLocalizedField(TranslationKey.str_game_stats_quiz, stats.BuildQuizStatsString(), true);
                emb.AddLocalizedField(TranslationKey.str_game_stats_ar, stats.BuildAnimalRaceStatsString(), true);
                emb.AddLocalizedField(TranslationKey.str_game_stats_rr, stats.BuildRussianRouletteStatsString(), true);
                emb.AddLocalizedField(TranslationKey.str_game_stats_tr, stats.BuildTypingRaceStatsString(), true);
                emb.AddLocalizedField(TranslationKey.str_game_stats_hm, stats.BuildHangmanStatsString(), true);
            }
        });
    }
    #endregion
