    ...
    public sealed partial class ChannelModule : TheGodfatherModule
    {
                             ...
                             [Description(TranslationKey.desc_chn_info)] DiscordChannel? channel = null)
        {
            ...
            return ctx.RespondWithLocalizedEmbedAsync(emb => {
                ...
                emb.AddLocalizedField(TranslationKey.str_chn_type, channel.Type, inline: true);
                emb.AddLocalizedField(TranslationKey.str_nsfw, channel.IsNSFW, inline: true);
                emb.AddLocalizedField(TranslationKey.str_pos, channel.Position, inline: true);
                emb.AddLocalizedField(TranslationKey.str_ratelimit, channel.PerUserRateLimit, inline: true, unknown: false);
                if (channel.Type == ChannelType.Voice) {
                    emb.AddLocalizedField(TranslationKey.str_bitrate, channel.Bitrate, inline: true);
                    if (channel.UserLimit > 0)
                        emb.AddLocalizedField(TranslationKey.str_user_limit, channel.UserLimit, inline: true);
                }
                emb.AddLocalizedTimestampField(TranslationKey.str_created_at, channel.CreationTimestamp, inline: true);
            });
        }
        #endregion
