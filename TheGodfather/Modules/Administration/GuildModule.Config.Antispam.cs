            ...
            public class AntispamModule : TheGodfatherServiceModule<AntispamService>
            {
                ...
                public Task ExecuteGroupAsync(CommandContext ctx)
                {
                    ...
                    if (gcfg.AntispamSettings.Enabled) {
                        ...
                        sb.Append("Action: ").AppendLine(gcfg.AntispamSettings.Action.ToString());
                        return this.InformAsync(ctx, $"Antispam watch for this guild is {Formatter.Bold("enabled")}\n{sb.ToString()}");
                    } else {
                        return this.InformAsync(ctx, $"Antispam watch for this guild is {Formatter.Bold("disabled")}");
                    }
                }
