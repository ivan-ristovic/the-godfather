...
public sealed class StarboardModule : TheGodfatherServiceModule<StarboardService>
{
    ...
    public async Task ExecuteGroupAsync(CommandContext ctx)
    {
        ...
        await ctx.RespondWithLocalizedEmbedAsync(emb => {
            ...
            emb.AddLocalizedField(TranslationKey.str_status, cid == 0 ? TranslationKey.str_disabled : TranslationKey.str_enabled, true);
            emb.AddLocalizedField(TranslationKey.str_chn, starChn?.Mention, true, false);
            emb.AddLocalizedField(TranslationKey.str_star, starEmoji, true, false);
            emb.AddLocalizedField(TranslationKey.str_sensitivity, this.Service.GetStarboardSensitivity(ctx.Guild.Id), true);
            emb.AddLocalizedField(TranslationKey.str_starmsgs, totalMsgs, true, false);
            emb.AddLocalizedField(TranslationKey.str_stars_total, totalStars, true, false);
        });
    }
    #endregion
    ...
    private async Task InternalStarboardAsync(CommandContext ctx, bool enable, DiscordChannel channel, DiscordEmoji? emoji = null, int? sens = null)
    {
        ...
        await ctx.GuildLogAsync(emb => {
            emb.WithLocalizedTitle(TranslationKey.evt_sb_upd);
            emb.WithColor(this.ModuleColor);
            emb.AddLocalizedField(TranslationKey.str_status, emoji is null ? TranslationKey.str_disabled : TranslationKey.str_enabled, true);
            emb.AddLocalizedField(TranslationKey.str_chn, channel.Mention, true, false);
            emb.AddLocalizedField(TranslationKey.str_star, emoji ?? Emojis.Star, true, false);
            emb.AddLocalizedField(TranslationKey.str_sensitivity, this.Service.GetStarboardSensitivity(ctx.Guild.Id), true);
        });
