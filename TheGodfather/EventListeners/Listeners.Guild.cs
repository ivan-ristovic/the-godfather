...
internal static partial class Listeners
{
        ...
        emb.AddFieldsFromAuditLogEntry(entry, (emb, ent) => {
            ...
            switch (action) {
                case AuditLogActionType.EmojiCreate:
                    emb.AddLocalizedField(TranslationKey.evt_gld_emoji_add, ent.Target.Name, true);
                    break;
                case AuditLogActionType.EmojiDelete:
                    emb.AddLocalizedField(TranslationKey.evt_gld_emoji_del, ent.NameChange.Before, true);
                    break;
                case AuditLogActionType.EmojiUpdate:
                    emb.AddLocalizedPropertyChangeField(TranslationKey.str_name, ent.NameChange, true);
                    break;
            }
        });

        if (entry is null) {
            emb.AddLocalizedField(TranslationKey.evt_gld_emoji_bef, e.EmojisBefore?.Count, true);
            emb.AddLocalizedField(TranslationKey.evt_gld_emoji_aft, e.EmojisAfter?.Count, true);
        }
        ...
        emb.AddFieldsFromAuditLogEntry(entry, (emb, ent) => {
            ...
            switch (action) {
                case AuditLogActionType.StickerCreate:
                    emb.AddLocalizedField(TranslationKey.evt_gld_sticker_add, ent.Target.Name, true);
                    break;
                case AuditLogActionType.StickerDelete:
                    emb.AddLocalizedField(TranslationKey.evt_gld_sticker_del, ent.NameChange.Before, true);
                    break;
                case AuditLogActionType.StickerUpdate:
                    emb.AddLocalizedPropertyChangeField(TranslationKey.str_name, ent.NameChange, true);
                    emb.AddLocalizedPropertyChangeField(TranslationKey.str_tags, ent.TagsChange, true);
                    emb.AddLocalizedPropertyChangeField(TranslationKey.str_available, ent.AvailabilityChange, true);
                    emb.AddLocalizedPropertyChangeField(TranslationKey.str_asset, ent.AssetChange, true);
                    emb.AddLocalizedPropertyChangeField(TranslationKey.str_format, ent.FormatChange, true);
                    emb.AddLocalizedPropertyChangeField(TranslationKey.str_type, ent.TypeChange, true);
                    emb.AddLocalizedPropertyChangeField(TranslationKey.str_desc, ent.DescriptionChange, true);
                    break;
            }
        });

        if (entry is null) {
            emb.AddLocalizedField(TranslationKey.evt_gld_emoji_bef, e.StickersBefore?.Count, true);
            emb.AddLocalizedField(TranslationKey.evt_gld_emoji_aft, e.StickersAfter?.Count, true);
        }
    ...
    public static async Task GuildRoleCreateEventHandlerAsync(TheGodfatherBot bot, GuildRoleCreateEventArgs e)
    {
        ...
        emb.AddLocalizedPropertyChangeField(TranslationKey.str_managed, false, e.Role?.IsManaged ?? false, true);
    ...
    public static Task InviteCreatedEventHandlerAsync(TheGodfatherBot bot, InviteCreateEventArgs e)
    {
        ...
        emb.AddLocalizedField(TranslationKey.str_code, e.Invite.Code, true);
        emb.AddLocalizedField(TranslationKey.str_revoked, e.Invite.IsRevoked, true);
    ...
    public static Task InviteDeletedEventHandlerAsync(TheGodfatherBot bot, InviteDeleteEventArgs e)
    {
        ...
        emb.AddLocalizedField(TranslationKey.str_max_age_s, e.Invite.MaxAge, true);
        emb.AddLocalizedField(TranslationKey.str_max_uses, e.Invite.MaxUses, true);
        emb.AddLocalizedField(TranslationKey.str_created_by, e.Invite.Inviter?.Mention, true, false);
