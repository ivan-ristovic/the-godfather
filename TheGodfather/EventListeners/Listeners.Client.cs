    ...
    internal static partial class Listeners
    {
        ...
        public static async Task GuildCreateEventHandlerAsync(TheGodfatherShard shard, GuildCreateEventArgs e)
        {
            ...
            await defChannel.EmbedAsync(
                ...
                $"{Emojis.SmallBlueDiamond} The default prefix for commands is {Formatter.Bold(shard.Services.GetService<BotConfigService>().CurrentConfiguration.Prefix)}, but it can be changed using {Formatter.Bold("prefix")} command.\n" +
                $"{Emojis.SmallBlueDiamond} I advise you to run the configuration wizard for this guild in order to quickly configure functions like logging, notifications etc. The wizard can be invoked using {Formatter.Bold("guild config setup")} command.\n" +
